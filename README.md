...
----
* Для групп 36-39 надо написать `Scanner` используя побайтовое считывание!
* Для групп 38-39 запрешено использовать регулярные выражения, функцию `split`, класс `StringTokenazir` и аналоги.
